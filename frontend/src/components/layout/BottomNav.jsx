...
const CUSTOMER_LINKS = [
  ...
  { to: "/requests/mine", label: "Requests", icon: "requests" },
  { to: "/profile", label: "Profile", icon: "profile" },
];

const PROVIDER_LINKS = [
  { to: "/provider/dashboard", label: "Dashboard", icon: "dashboard" },
  { to: "/provider/requests", label: "Requests", icon: "requests" },
  { to: "/provider/bookings", label: "Bookings", icon: "bookings" },
  { to: "/provider/profile", label: "Profile", icon: "profile" },
];
        ...
        <>
          ...
          >
            ...
            <div className="hero-nav-links">
              {links.map((link) => (
                <NavLink key={link.to} to={link.to} className="nav-item hero-nav-link"><Icon name={link.icon} />{link.label}</NavLink>
              ))}
            </div>
          </nav>
        </>
