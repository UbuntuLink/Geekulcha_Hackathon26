...
export default function AIServiceIdentification() {
  ...
  return (
    <Screen title={t("customer.understandingTitle")} subtitle={t("customer.understandingSubtitle")} eyebrow="Step 3 of 3">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-brand p-5 text-white shadow-lift">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.15em] text-white/55">{t("customer.serviceIdentified")}</p>
      ...
      <Card className="mt-4">
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-gray-400">{t("customer.yourProblem")}</p>
        <p className="mt-2 text-sm font-semibold leading-6 text-ink">{classification.job_description}</p>
      </Card>

      <div className="mt-6">
        <div className="flex items-center justify-between text-sm">
          <p className="font-bold text-ink">{t("customer.findingProviders")}</p>
